...
def main():
    ...
    capture_eth_data = input("Do you want to capture Hexed Ethernet Data (Hexdump) (y for yes, press enter to ignore)? ").lower() == 'y'
    capture_raweth_data = input("Do you want to capture Raw Ethernet Data (y for yes, press enter to ignore)? ").lower() == 'y'
